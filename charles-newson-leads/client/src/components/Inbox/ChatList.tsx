    ...
    return (
        <div className='chat-list primary-light-bg p-3 me-2'>
            <div className='d-flex align-items-center justify-content-between'>
                ...
                <Dropdown autoClose='outside' className='chat-filter mt-6'>
                    <Dropdown.Toggle className='btn-primary2 px-2 min-h-[unset] h-[unset]'>
                        <FiFilter size={18} />
                    </Dropdown.Toggle>
                                ...
                                return <Form.Check
                                    ...
                                    onChange={(e) => {
                                        e.target.checked ? (
                                            ...
                                            setIncludeCampaigns(includeCampaigns.filter((campaignId:any) => campaignId !== campaign.id))
                                        )
                                    }}
                                    type='checkbox'
                        ...
                        <Form.Check
                            ...
                            onChange={(e) => {
                                e.target.checked ? (
                                    ...
                                    setIncludePlatforms(includePlatforms.filter((platform:any) => platform !== "Linkedin"))
                                )
                            }}
                        />
                        <Form.Check
                            ...
                            onChange={(e) => {
                                e.target.checked ? (
                                    ...
                                    setIncludePlatforms(includePlatforms.filter((platform:any) => platform !== "Linkedin Sales"))
                                )
                            }}
                        />
                                ...
                                return <Form.Check
                                    ...
                                    onChange={(e) => {
                                        e.target.checked ? (
                                            ...
                                            setIncludeLabels(includeLabels.filter((labelId:any) => labelId !== label.id))
                                        )
                                    }}
                                />
                            })
                    ...
                    onClick={() => {
                        ...
                        setIncludeLabels(
                            includeLabels.filter(
                                (labelId:any) => !labels.filter((label:any) => label.default_label).map((item:any) => item.id).includes(labelId)
                            )
                        )
                    }}
                    className={'me-1 mb-1 ' + (!unReadMessagesOnly && !includeLabels.length ? 'active btn btn-primary2' : 'btn-ghost hover:bg-[unset] capitalize')}
                >
                    All
                </Button>
                <Button
                    ...
                    className={'me-1 mb-1 ' + (unReadMessagesOnly ? 'active btn btn-primary2' : 'btn-ghost hover:bg-[unset] capitalize')}
                >
                    Unread
                </Button>
                {
                    labels.filter((label:any) => label.default_label).map((label:any, index:number) => {
                        return <Button
                            variant='tab'
                            onClick={(e) => {
