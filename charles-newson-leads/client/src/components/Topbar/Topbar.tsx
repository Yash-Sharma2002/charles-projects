...
export default function Topbar(props: any) {
  ...
  const { organisation } = React.useContext(AppContext);
          ...
          <div className="col-md-12">
            <div className="d-flex justify-content-between">
              ...
              <div className="d-flex justify-content-end">
                ...
                <nav className={!isOpen ? "h-[10vh] fixed top-0  left-0 w-full bg-white z-50 block md:hidden": "h-[120vh] fixed top-0  left-0 w-full bg-white z-50 block md:hidden"}>
                ...
                <Dropdown align="end">
                  ...
                  <Dropdown.Menu className="user-menu shadow-sm">
                    <Link to="/organisation-details" className="link d-flex">
                      <FaRegUser size={20} />
                      <p>Organisation Details</p>
                    </Link>
                    <div className="link d-flex" onClick={handleShow}>
