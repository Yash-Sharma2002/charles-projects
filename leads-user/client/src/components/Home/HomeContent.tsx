  ...
  return (
    <div className="home-content">
      {isLoading ? (
        ...
        <div className="flex flex-col-reverse md:flex-row g-0">
          <div className="col-md-9">
            <div className="content-section main-bg p-4 md:me-3 custom-scrollbar">
              <div className="d-flex flex-wrap mb-5">
                <div className="block md:flex me-3 mb-3">
          ...
          <div className="col-md-3 mt-2 md:mt-0">
            <div className="filter-section md:h-full main-bg p-4">
              ...
              <Accordion flush>
                ...
                <Accordion.Item eventKey="1-1" className="mb-2">
                  <Accordion.Header>
                    <MdAccessTime size={17} className="me-3" /> Period
                  </Accordion.Header>
                  <Accordion.Body>
                    {periods.map(function (item) {
                      return (
                        <Form.Check
                          ...
                          label={item.title}
                          onChange={(e) =>
                            e.target.checked && setPeriodInput(item.title)
                          }
                ...
                <Accordion.Item eventKey="1-2" className="mb-2">
                  <Accordion.Header>
                    <MdMoreTime size={17} className="me-3" /> Custom Period
                  </Accordion.Header>
                  <Accordion.Body>
                    <DatePicker
                      selectsRange={true}
              ...
              <button
                className="w-100 p-1 btn btn-primary2"
                disabled={isLoading}
              >
                Apply Filters
              </button>
