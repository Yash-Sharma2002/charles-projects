...
export default function ChatInfo({ activeChat, statusColor }: any) {
  ...
  const setDirectEmail = (value: string) => {
    setContacts({ ...contacts, directEmail: value });
  };
  const setDirectPhone = (value: string) => {
    setContacts({ ...contacts, directPhone: value });
  };
  const setDirectTwitter = (value: string) => {
  ...
  const toggleCampStatus = () => {
    ...
    //   !refCampaign.status ? toast.success('Campaign Started!') : toast.success('Campaign Paused!');
  };
    ...
    <div className="chat-info p-3 custom-scrollbar">
      <div className="user-info mb-3">
        <div className="d-flex">
          ...
          >
            {/* <img
              src={buildAvatarRoute(
                activeChat.prospect_details.linkedin_avatar
              )}
              alt=""
            /> */}
          </a>
        ...
        <div className="company-item d-flex">
          ...
          <div className="comp-data ms-2">
            ...
            <p className="designation mb-0">
              {activeChat.prospect_details.occupation}
            </p>
          </div>
        </div>
      </div>
          ...
          <Accordion.Body>
            <div className="camp-data">
              ...
              <div className="camp-data-head d-flex justify-content-between">
                <p className="camp-title mb-0">
                  {activeChat.campaign_details.name}
                </p>
                <p
                  className={`camp-status mb-0 ${
                    activeChat.campaign_details.status !== "Running"
                      ? "inactive"
                      : ""
                  }`}
                >
