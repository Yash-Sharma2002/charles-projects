          ...
          >
            {fileteredCountries.map((data, i) => (
              <div
                ...
                className="flex items-center justify-between text-black px-4 py-2 border-b border-gray-200 cursor-pointer hover:bg-[#2A83EC] hover:text-white  transition-all"
              >
